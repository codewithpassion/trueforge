/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.wrangler/empty.env` (hash: a235b8d59fc62a75d7fceb637b2e1c22)
...
interface __BaseEnv_Env {
	...
	OIDC_CLIENT_ID: "trueforge-workers-local";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRUEFORGE_RUNTIME" | "OIDC_ISSUER_URL" | "OIDC_CLIENT_ID" | "PUBLIC_BASE_URL">> {}
}
