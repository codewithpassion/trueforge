/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.wrangler/empty.env` (hash: b456ecc341c906149d99c78a174ca359)
...
interface __BaseEnv_Env {
	...
	SESSION_DO: DurableObjectNamespace<import("./src/workers/index").SessionDO>;
	SCHEDULER_DO: DurableObjectNamespace<import("./src/workers/index").SchedulerDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/index");
		durableNamespaces: "SessionDO" | "SchedulerDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRUEFORGE_RUNTIME" | "OIDC_ISSUER_URL" | "OIDC_CLIENT_ID" | "PUBLIC_BASE_URL" | "OIDC_USER_ROLE_CLAIM" | "OIDC_ADMIN_ROLE_VALUE" | "OIDC_ALLOWED_EMAILS">> {}
}
