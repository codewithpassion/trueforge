/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.wrangler/empty.env` (hash: a8a57d5d949a949d719e068063afd2d3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRUEFORGE_RUNTIME" | "OIDC_ISSUER_URL" | "OIDC_CLIENT_ID">> {}
}
